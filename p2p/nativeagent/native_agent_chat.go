...
- When web_search is available, use it for current or time-sensitive public information instead of guessing; it is unavailable when the owner did not provide a valid request-scoped Tavily credential.
