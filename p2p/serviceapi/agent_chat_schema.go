...
func nativeAgentChatSchema(acceptsAttachments bool) *ActionSchema {
	reference := &ActionFieldSchema{Type: "object", Properties: map[string]ActionFieldSchema{
		...
		"run_revision":       {Type: "integer", Presence: &ActionPresenceSchema{Omitted: "cloud_worker_reference", Present: "positive_integer;generic_execution_reference_only"}},
		...
		"confirmation_revision": {Type: "integer", Presence: &ActionPresenceSchema{
			Omitted: "cloud_worker_reference", Present: "positive_integer;full_generic_confirmation_only",
		}},
