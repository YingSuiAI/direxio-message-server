...
func nativeAgentChatSchema(acceptsAttachments bool) *ActionSchema {
	reference := &ActionFieldSchema{Type: "object", Properties: map[string]ActionFieldSchema{
		...
		"plan_digest":        {Type: "string", Presence: &ActionPresenceSchema{Present: "lowercase_sha256;required_by_plan_linkage"}},
		"run_id":             {Type: "string", Presence: &ActionPresenceSchema{Present: "canonical_uuid;required_by_run_linkage"}},
		"run_revision":       {Type: "integer", Presence: &ActionPresenceSchema{Present: "positive_integer;required_by_run_linkage"}},
		"run_digest":         {Type: "string", Presence: &ActionPresenceSchema{Present: "lowercase_sha256;required_by_run_linkage_except_full_generic_confirmation"}},
		...
		"execution_id":       {Type: "string", Presence: &ActionPresenceSchema{Omitted: "generic_execution_v2_reference", Present: "canonical_uuid_equal_to_run_id;required_with_task_id"}},
		"confirmation_id":    {Type: "string", Presence: &ActionPresenceSchema{Present: "canonical_uuid;required_by_confirmation_linkage"}},
		"confirmation_revision": {Type: "integer", Presence: &ActionPresenceSchema{
			Present: "positive_integer;required_for_cloud_worker_or_full_generic_confirmation",
		}},
		...
		"binding_digest":   {Type: "string", Presence: &ActionPresenceSchema{Present: "lowercase_sha256;cloud_worker_confirmation_binding_or_generic_binding"}},
		"quote_digest":     {Type: "string", Presence: &ActionPresenceSchema{Omitted: "generic_execution_v2_reference", Present: "lowercase_sha256;required_with_task_id"}},
		"execution_digest": {Type: "string", Presence: &ActionPresenceSchema{Omitted: "generic_execution_v2_reference", Present: "lowercase_sha256;required_with_task_id"}},
