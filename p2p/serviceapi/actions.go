...
var actionSpecs = []ActionSpec{
	...
	{Name: "agent.schedules.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleGetSchema()},
	{Name: "agent.schedules.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleListSchema()},
	{Name: "agent.schedules.delete", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleMutationSchema()},
	{Name: "agent.schedules.enable", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleMutationSchema()},
	{Name: "agent.schedules.disable", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleMutationSchema()},
	{Name: "agent.schedules.run_now", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleRunNowSchema()},
	{Name: "agent.schedule_runs.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleRunsListSchema()},
	{Name: "agent.schedule_runs.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: embeddedScheduleRunGetSchema()},
	...
	{Name: "agent.core.workloads.plan", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadPlanSchema()},
	{Name: "agent.core.workloads.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadGetSchema()},
	{Name: "agent.core.workloads.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadListSchema()},
	{Name: "agent.core.workloads.quote", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadQuoteSchema()},
	{Name: "agent.core.workloads.apply", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadApplySchema()},
	{Name: "agent.core.workloads.destroy", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadDestroySchema()},
	{Name: "agent.core.workloads.operations.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadOperationGetSchema()},
	{Name: "agent.core.workloads.operations.events", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadOperationEventsSchema()},
	{Name: "agent.core.workloads.operations.reconcile", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadOperationReconcileSchema()},
	{Name: "agent.core.workloads.actual.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreWorkloadActualGetSchema()},
	{Name: "agent.core.dashboard.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreDashboardGetSchema()},
	{Name: "agent.core.deployments.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreDeploymentsListSchema()},
	{Name: "agent.core.deployments.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreDeploymentsGetSchema()},
	{Name: "agent.core.deployments.events", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreDeploymentsEventsSchema()},
	...
	{Name: "agent.core.aws.plans.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSPlanReadSchema()},
	{Name: "agent.core.aws.plans.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSPlanListSchema()},
	{Name: "agent.core.aws.plans.quote", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSQuoteSchema()},
	{Name: "agent.core.aws.changes.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSChangeGetSchema()},
	{Name: "agent.core.aws.changes.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSChangeListSchema()},
	{Name: "agent.core.aws.changes.status", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSChangeStatusSchema()},
	{Name: "agent.core.aws.ec2_provisions.plan", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionPlanSchema()},
	{Name: "agent.core.aws.ec2_provisions.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionGetSchema()},
	{Name: "agent.core.aws.ec2_provisions.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionListSchema()},
	{Name: "agent.core.aws.ec2_provisions.events", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionEventsSchema()},
	{Name: "agent.core.aws.ec2_provisions.create.request", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionChangeRequestSchema()},
	{Name: "agent.core.aws.ec2_provisions.destroy.request", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionChangeRequestSchema()},
	{Name: "agent.core.aws.ec2_provisions.retry", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionRetrySchema()},
	{Name: "agent.core.aws.ec2_provisions.geolibre_install.plan", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionGeoLibreInstallPlanSchema()},
	{Name: "agent.core.aws.ec2_provisions.geolibre_install.request", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreAWSEC2ProvisionGeoLibreInstallRequestSchema()},
