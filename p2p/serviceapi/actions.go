...
var actionSpecs = []ActionSpec{
	...
	{Name: executionV2Name("runs.reconcile"), Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: executionV2Schema("runs.reconcile")},
	...
	{Name: executionV2Name("confirmations.get"), Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: executionV2Schema("confirmations.get")},
	{Name: executionV2Name("confirmations.list"), Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: executionV2Schema("confirmations.list")},
	{Name: executionV2Name("confirmations.confirm"), Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: executionV2Schema("confirmations.confirm")},
	{Name: executionV2Name("confirmations.reject"), Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: executionV2Schema("confirmations.reject")},
