...
var actionSpecs = []ActionSpec{
	...
	{Name: "agent.config.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: agentConfigSchema(false)},
	{Name: "agent.config.update", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: agentConfigSchema(true)},
	...
	{Name: "agent.core.mcp.discover", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPDiscoverSchema()},
	{Name: "agent.core.mcp.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPGetSchema()},
	{Name: "agent.core.mcp.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPListSchema()},
	{Name: "agent.core.mcp.inspect", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPInspectSchema()},
	{Name: "agent.core.mcp.install", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPInstallSchema()},
	{Name: "agent.core.mcp.update", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPUpdateSchema()},
	{Name: "agent.core.mcp.remove", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreMCPRemoveSchema()},
	...
	{Name: "agent.core.skills.discover", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillDiscoverSchema()},
	{Name: "agent.core.skills.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillGetSchema()},
	{Name: "agent.core.skills.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillListSchema()},
	{Name: "agent.core.skills.inspect", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillInspectSchema()},
	{Name: "agent.core.skills.install", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillInstallSchema()},
	{Name: "agent.core.skills.update", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillUpdateSchema()},
	{Name: "agent.core.skills.remove", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: coreSkillRemoveSchema()},
	...
	{Name: "agent.memory.config.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: memoryConfigSchema(false)},
	{Name: "agent.memory.config.update", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: memoryConfigSchema(true)},
	...
	{Name: "agent.workers.list", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: workerListSchema()},
	{Name: "agent.workers.get", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: workerGetSchema()},
	{Name: "agent.workers.destroy", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: workerDestroySchema()},
	{Name: "agent.workers.bind_domain", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: workerBindDomainSchema(false)},
	{Name: "agent.workers.unbind_domain", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS, Schema: workerBindDomainSchema(true)},
