...
var expectedCatalogSchemaDigests = map[string]catalogSchemaDigest{
	...
	"agent.chat.stream": {
		...
		eventHex:  "7eedc9a60b558c8031805be2279b224a734c60e3223d80ce7397281ccdfea2e8",
	},
	...
	"agent.chat.turn.stop": {
		inputHex:  "eaa73fde17ad29c4d721b6e07e17e0f472d88fb63b2d6b0112f6d385f67445da",
		resultHex: "5031fafc12966ca78f1c41730d87f967f622647042719a67dca2619cfb737763",
	},
	"agent.chat.turn.steer": {
		inputHex:  "c1ae3c51dce6a692ae5c5b2147b4403be05f2ce3d566a0a516aa7e3ea3887e95",
	...
	"agent.workers.list": {
		inputHex:  "99334726611ccf58a148b0814696bfa6fe08c1b2d027e946beccf5a74331c9aa",
		resultHex: "5c221f9891273445bfa07008f06906e6dc2c2e4aa71b23161dfcf49bc49d4734",
	},
	"agent.workers.get": {
	...
	"agent.workers.destroy": {
		...
		resultHex: "0d394a7b6edb59049bdf60632240ab2b86ec7f68d1ec4dbb38999df2c6e142c5",
	},
	"agent.workers.bind_domain": {
		inputHex:  "4c955b6d394809fb3078dabb96bcfbe755ebffc2b1bfbbfab131b70a1db16945",
		resultHex: "2175236e6f85c623b24bff00d8e7f1b77fc1920a2554ef40d383ea3c19a2b8b2",
	},
	"agent.workers.unbind_domain": {
		inputHex:  "a5cbf754338f814b6b602ed69ac78c27f27ad0abfda91c75c92f1fee9967cc6f",
		resultHex: "8bb3bc93338217f4a826dd0298668605c837922712cff67e068a6d8fe2c17428",
	},
	...
	"agent.execution.v2.plans.get": {
		inputHex:  "56b8a5c9984e9387319a1be5bbcdb75a9687cb9aaf547c8c93b91dd5c525c6c9",
		resultHex: "8cd777a4a1810b2ddf23641245e8454db53acf35407d32f4cf057eb512b247ec",
	},
	"agent.execution.v2.plans.list": {
		inputHex:  "c1ee32f9d10fc353a747c76dfb60e96b7210e6cfac8a570f7718c1a4cc20ec81",
		resultHex: "5e37de999713d54a5c03e06b67f03f713bfeade1ff9beccd28942f0a6f422efb",
	},
	"agent.execution.v2.runs.get": {
		inputHex:  "0f26c76e73e231975f70223c8be6058b1837ac7da88c65505cd2c9668209b897",
	...
	"agent.execution.v2.runs.cancel": {
		inputHex:  "d2e01d84a857d260180d3a3b381e8076d18451788123a428c4bfee7a5570c0da",
		resultHex: "752ff0a18f7227c054c4e8d901bb1ddb13ea345987001e012c9b699350e61716",
	},
	"agent.execution.v2.runs.events": {
		inputHex:  "2d388e15959b44af64f86fba486f2cfbf4dd84276e7a8e0ee6a3a9c36e8daf5c",
